...
// ReactBits Aurora — verbatim TypeScript port
...
export function AuroraBg({
  colorStops = ["#1a1428", "#3d2060", "#1a1428"],
  amplitude = 0.9,
  blend = 0.5,
  speed = 1.0,
}: AuroraBgProps) {
  ...
  }, [amplitude]); // amplitude is the only prop that triggers full re-init; others update via propsRef
