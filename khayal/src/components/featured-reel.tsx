  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[2px] bg-[var(--accent)]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
