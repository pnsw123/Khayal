...
The full interface was designed in [Google Stitch](https://stitch.withgoogle.com) — an AI design tool that generates real UI screens from text prompts. Every layout, color decision, and component was produced in Stitch before any code was written.

| Browse — generated by Stitch | Search results |
|:---:|:---:|
| ![Stitch Browse](screenshots/stitch-output-browse.png) | ![Stitch Search](screenshots/stitch-output-search.png) |

| Movie detail page | Arabic filter view |
|:---:|:---:|
| ![Stitch Detail](screenshots/stitch-output-detail.png) | ![Stitch Arabic](screenshots/stitch-output-arabic.png) |
